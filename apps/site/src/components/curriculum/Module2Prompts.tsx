...
// Inline prompts for Module 2. Same shape as Module 1 — useCard hook
// reads & writes the IndexedDB store, InlinePrompt renders the
// instrument via the shared registry. Sibling-of-Module-1 duplication
// is intentional; a real abstraction lands once a fourth module wants
// the same pattern.
